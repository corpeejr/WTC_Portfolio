                                    ...
                                    <div class="history-scroller">
                                        <div class="history-item">
                                            ...
                                            <div class="history-text">
                                                <h5>Starz University, College of Science and Technology</h5>
                                                <span>Present - 2018</span>
                                            </div>
                                        </div>
                                        <!-- /.history-item -->
                                        <div class="history-item">
                                            ...
                                            <div class="history-text">
                                                <h5>A.M.E.Zion Academy high school</h5>
                                                <span>2018 - 2015</span>
                                            </div>
                                        </div>
                                        <!-- /.history-item -->
                                        <div class="history-item">
                                            ...
                                            <div class="history-text">
                                                <h5>Conquerors Christian Foundation Academy</h5>
                                                <span>2015 - 2012</span>
                                            </div>
                                        </div>
                                        <!-- /.history-item -->
                                        <div class="history-item">
                                            ...
                                            <div class="history-text">
                                                <h5>Ganta United Methodist High School</h5>
                                                <span>2012 - 2007</span>
                                            </div>
                                        </div>
                                        <!-- /.history-item -->
